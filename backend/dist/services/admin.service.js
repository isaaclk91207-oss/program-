...
class AdminService {
    async getDashboard() {
        const [totalRequests, pendingRequests, assignedRequests, qrPendingRequests, inProgressRequests, completedRequests, feedbackSubmittedRequests, totalDrivers, activeDrivers, totalVehicles, activeVehicles, requestsByStatus, recentRequests,] = await Promise.all([
        ...
        switch (type) {
            case "drivers": {
                ...
                return drivers.map((d) => ({
                    ...
                    rating: d.feedbackRecords.length > 0
            ...
            case "feedback": {
                ...
                return feedbacks.map((f) => ({
                    ...
                    rating: f.rating,
                    comment: f.comment,
                    tags: (typeof f.tags === "string" ? JSON.parse(f.tags) : f.tags).join("; "),
