...
import { ArrowLeft, Mail, Car, Star } from "lucide-react";
      ...
      <Card className="p-4 text-center">
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          <div className={`${th.bgInput} rounded-lg p-3`}>
            <Car className="w-5 h-5 text-amber-500 dark:text-amber-400 mx-auto mb-1" />
            <p className="text-lg font-bold text-amber-500 dark:text-amber-400">{trips.length}</p>
            <p className={`text-xs ${th.textMuted}`}>Total Trips</p>
          </div>
          <div className={`${th.bgInput} rounded-lg p-3`}>
